...
// or [htmlify]{/p}{p class="my_class lead"}SOMETHING BEFORE{span class="red-link"} >[/htmlify]
// or [htmlify]{/p}{h1 class="my_class lead"}This text for more information{span class="red-link"} >{/span}{/h1}[/htmlify]
